...
const Testimonials=()=>{
   ...
   const CreateCard = ({ card }) => (
       <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-gray-900 border border-gray-800">
           ...
           <p className="text-sm py-4 text-gray-300">Radiant made undercutting all of our competitors an absolute breeze.</p>
       </div>
   );
    return (
        <div className="bg-black min-h-screen w-full py-16">
            ...
            <div className="text-center mb-12">
                <div className="flex items-center justify-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1 w-max mx-auto mb-4">
                ...
                <p className="text-slate-300 max-w-2xl mx-auto">
                    Hear from professionals who've transformed their careers with our resume builder.
                </p>
            </div>
           <style>{`
