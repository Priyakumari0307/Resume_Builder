...
import { ArrowLeftIcon, FolderIcon, Sparkle, GraduationCap, Briefcase, FileText, User, ChevronLeft, ChevronRight, Share2Icon, EyeIcon, EyeOffIcon, DownloadIcon, LoaderCircle } from "lucide-react";
                    ...
                    <div className='lg:col-span-7 max-lg:mt-6'>
                        <div className="relative w-full">
                            <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                                ...
                                <button onClick={downloadResume} className='flex items-center gap-2 px-6 py-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-1g ring-green-300 hover: ring transition-colors'> <DownloadIcon className='size-4' /> Download
                                </button>
                            </div>
                        </div>
